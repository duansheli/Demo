...
public class OaBranchAib {
    ...
    /**
     * 是否删除（0：已删除、1：正常、2：历史记录）
     */
    private Integer isDelete;

    /**
     * 网点唯一标志和第四期关联
     * @return bid 网点唯一标志和第四期关联
     */
    ...
    /**
     * 是否删除（0：已删除、1：正常、2：历史记录）
     * @return is_delete 是否删除（0：已删除、1：正常、2：历史记录）
     */
    ...
    /**
     * 是否删除（0：已删除、1：正常、2：历史记录）
     * @param isDelete 是否删除（0：已删除、1：正常、2：历史记录）
     */
