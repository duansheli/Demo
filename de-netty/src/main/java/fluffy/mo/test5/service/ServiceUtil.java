...
import fluffy.mo.test5.Test5_Client;
import fluffy.mo.test5.Test5_ClientHandler;
import fluffy.mo.test5.Test5_Server;
import fluffy.mo.test5.core.RpcMessage;
import fluffy.mo.test5.core.RpcRequest;
import org.apache.commons.lang3.StringUtils;

import fluffy.mo.test5.core.RpcResponse;
    ...
    return (T) Proxy.newProxyInstance(interfaceClass.getClassLoader(), new Class<?>[] { interfaceClass },
        new InvocationHandler() {
          ...
          public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            Test5_Client.Sender.getInstance().getMessageSendHandler().sendRequest(msg);
            // 获取结果
